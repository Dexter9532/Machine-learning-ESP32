 ...
 */
template <> struct is_unsigned<bool> {
 ...
 */
template <> struct is_unsigned<uint8_t> {
  static const bool value{true};
};
 ...
 */
template <> struct is_unsigned<uint16_t> {
  static const bool value{true};
};
 ...
 */
template <> struct is_unsigned<uint32_t> {
  static const bool value{true};
};
 ...
 */
template <> struct is_unsigned<uint64_t> {
  static const bool value{true};
};
...
/**
 * @brief Check if given type is of arithmetic type, i.e. integral or
 * floating-point type.
 *
 * @tparam T The type to check.
 */
 ...
 */
template <> struct is_string<const char *> {
  static const bool value{true};
};
